...
export default function OfferPage() {
  return (
    <div>
       <section className="overflow-hidden bg-white py-8 sm:py-16 font-mono">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="lg:pr-8 lg:pt-4">
                        <div className="lg:max-w-lg">
                            <h2 className="text-2xl font-semibold leading-7 text-red-300">
                                Sleep Better
                            </h2>
                                ...
                                <div className="relative pl-9">
                                    <dt className="inline font-semibold text-gray-900">
                                        <svg
                                            ...
                                            fill="currentColor"
                                            aria-hidden="true"
                                            className="absolute left-1 top-1 h-5 w-5 text-red-300">
                    ...
                    <img
                        ...
                        className="w-[48rem] max-w-full rounded-xl   sm:w-[57rem] md:-ml-4 lg:-ml-0"
                        width={2432}
                        height={1442}
                    />
                </div>
