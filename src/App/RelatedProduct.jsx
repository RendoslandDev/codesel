...
export default function RelatedProduct({relatedProducts}) {
  return (
    <>
      <section className='flex justify-center bg-white sm:py-16 lg:py-5 px-auto  font-serif'>
  <div className='mr-20 grid grid-cols-2 mt-10 gap-5 lg-mt-16 lg:gap-4 lg:grid-cols-4'>
