    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                <h2 className="animate-pulse uppercase font-serif text-gray-600 font-manrope text-4xl font-semibold leading-10 mb-11">
                     Message Us
                      </h2>
                <input
                    type="text"
                ...
                <div className="mb-10">
                    ...
                    <div className="flex">
                        <div className="flex gap-2 items-center mr-11">
                            <input
                                id="Email"
                                type="radio"
                            ...
                            <label
                                htmlFor="Email"
                                className="flex  font-mono items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                                Email
                            </label>
                        </div>
