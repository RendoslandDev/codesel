    ...
    <>
      ...
      <main className='sm:m-12 lg-m-[4.5rem] !mt-[155px] sm:!mt-[190px] font-serif loading-lazy'>
        ...
        <div className='container text-2xl font-serif m-auto px-15 text-black '>
          ...
          <p className='font-mono mb-5'>That fit all styles, relaxations, comfortness , availability and majoring</p>
          <span className='font-extralight text-xl'>At <strong className='text-red-300'>Cloudsale</strong>  , we offer a wide range of mattress for the whole family or completing an apartment in variety of sizes
            and firmness levels. Our bedding sets include bedsheets , duvet covers , pillowcases and bedspreads, everything you need for acomplete 
            stylishing an apartment and stylishing bedding ...
          </span>
    ...
    <div className='container m-auto px-6 text-gray-600 md:px-12 xl:px-6 mb-10'>
      ...
      <div className="w-full lg:w-[50%] mb-6">
        ...
        <div className="lg:w-[50%] lg:mt-[200px]">
          ...
          <button className='bg-[#e41b35] p-2 rounded w-[200px] text-white font-extralight text-2'>ACCRA-024 335 2683</button>
          <button className='bg-[#e41b35] p-2 rounded w-[300px] text-white font-thin text-2'>KUMASI-024 151 2738/ 024 469 3264</button>
    ...
    <div className='container m-auto text-gray-600 md:px-12 xl:px-6 bg-white  rounded  '>
      ...
      <div className="w-full lg:w-[50%] mb-6 grid place-items-center shadow p-4">
          ...
          <span className='grid place-items-center p-10 font-serif'>
            I bought a queen sized bed fro Ashfoam, i've been
            using it for 5years and it's still strong and very comfortable. i encourage every who wants to live comfortably in their 
            home to visit Ashfoam for their package because it's very comfortable and durable.
          </span>

          <img src="/helpdesk2.jpg" alt="picture of the writer" className='rounded-full h-[100px] mb-5'/>

          <span className='grid place-items-center font-serif'>Rita Antwiwaa - Allianz insurance company</span>
        </div>

        <div className="w-full lg:w-[50%] mb-6 grid place-items-center shadow p-4">
          <span className='font-serif'>"....Comfort was never compromised"</span>
          <h2 className='text-6xl'>''</h2>
          <span className='grid place-items-center p-10 font-serif'>
            With an extremely affordable prices of ASHFOAM sofas,
            I was very skeptical aboutits quality until i purchased it .
            I must say it's great and thinking about comfort ,
            it was never compromised.i will sincerely recommended
            ASHFOAM products to everyone.
          </span>

          <img src="./Arrival/download (3).jpeg" alt="picture of the writer" className='rounded-full h-[100px] mb-5'/>

          <span className='grid place-items-center font-serif'>Hayford Atim - IT Consultant</span>
        </div>
      </div>
      </div>
  ) 
...
function ContactReview(props) {
  ...
  <div className='container  h-[600px] mx-auto p-4 text-gray-600 md:px-12 xl:px-6 rounded' >
      ...
      <div className="w-full lg:w-[80%] mb-2 grid place-items-center list-none">
          <span className='text-gray-600 text-2xl font-mono mt-5'>General Enquires regarding Online Sales</span>
          ...
          <div className='bg-gray-200 block sm:mb-2  lg:flex flex-row list:none gap-2 h-[300px]  pl-20 pt-10  pr-20 rounded'> 
            <div className='container bg-white shadow-white rounded  flex justify-between h-35 gap-2  mb-2 '>
              ...
              <li className='pt-10 font-bold'>Free NationWide Delivery For Orders Above GHC200</li>
            </div> 
